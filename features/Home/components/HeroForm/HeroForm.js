    ...
    return (
        ...
        <Box width="100%"
         ...
         color="gray.700" >
            ...
            <Text fontSize="lg">Complete the form below to download you guide</Text>
            <form onSubmit={handleSubmit(onSubmit)}>
                <FormControl>
                    ...
                    <Flex gap={{base: "0", sm:"1rem"}} flexDirection={{base:"column", sm:"row"}}>
                        <Input marginTop='1.3rem' id="emai" type="email" placeholder="Email"
                        ...
                        <Input marginTop='1.3rem' id="phone" type="text" placeholder="Phone"
                    ...
                    <Checkbox marginTop='3rem' id='gdpr' type='checkbox' placeholder='GDPR' 
                ...
                padding='2rem' marginTop='2rem' >Download Now</Button>
            </form>
        </Box>
        </>
    )
